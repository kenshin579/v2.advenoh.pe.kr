  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          aria-label={t.mobile.activityPanel}
        ...
        >
          <Dialog.Title className="sr-only">{t.mobile.activityPanel}</Dialog.Title>
          <Dialog.Description className="sr-only">
            {t.mobile.activityPanelDesc}
          </Dialog.Description>
          <Dialog.Close
            aria-label={t.a11y.closeActivityPanel}
