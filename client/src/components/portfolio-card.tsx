...
export function PortfolioCard({ item, index }: PortfolioCardProps) {
  ...
  const title = item.title || getDomainFromUrl(item.site);
  
  // Using a placeholder service for website screenshots
  // Use placeholder gradient instead of unreliable screenshot service
